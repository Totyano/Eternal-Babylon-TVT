...
// Camo set
#define CAMO_UNIFORM "CUP_U_B_BDUv2_gloves_DCU_US", "CUP_U_B_BDUv2_DCU"
#define CAMO_VEST "CUP_V_B_Interceptor_Grenadier_M81", "CUP_V_B_Interceptor_Rifleman_M81"
#define CAMO_BACKPACK "CUP_B_USPack_Coyote_TL"
...
#define GLRIFLE_MAG_SMOKE "1Rnd_Smoke_Grenade_shell:6","1Rnd_SmokeRed_Grenade_shell:4","1Rnd_SmokeGreen_Grenade_shell:4"
...
class vicc: Fic_Soldier_Carbine {// Crew
  uniform[] = {"SP_0000_Standard_Coverall_Green"};
  backpack[] = {"B_Battle_Belt_XL_F"};
