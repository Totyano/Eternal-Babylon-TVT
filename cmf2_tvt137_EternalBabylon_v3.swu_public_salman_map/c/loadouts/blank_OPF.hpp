...
// Camo set
#define CAMO_UNIFORM "CFP_BDU_Green"
#define CAMO_VEST "PLOT_ARMOR_V_TacChestrig_grn_F"
#define CAMO_BACKPACK "B_Battle_Belt_XL_F"
#define CAMO_HEADGEAR "SP_M1Helmet_Tan"
// Camo set
#define SFCAMO_UNIFORM "CFP_U_KhetPartug_Long_White"
#define SFCAMO_VEST "PLOT_ARMOR_V_TacChestrig_grn_F"
#define SFCAMO_BACKPACK "B_Battle_Belt_XL_F"
...
#define GLRIFLE_MAG_SMOKE "CUP_1Rnd_SMOKE_GP25_M:6","CUP_1Rnd_SmokeRed_GP25_M:4","CUP_1Rnd_SmokeGreen_GP25_M:4"
#define GLRIFLE_MAG_HE "CUP_1Rnd_HE_GP25_M:2"
// Carbine
...
#define MMG_ATT ""
// MAT
#define MAT "launch_O_Vorona_green_F"
#define MAT_MAG "Vorona_HEAT:1"
#define MAT_MAG2 "Vorona_HEAT:1"
#define MAT_OPTIC ""
// Facewear
#define GOG "SP_Balaclava_White"
...
#define SNIPER_ATTACHMENTS "cup_muzzle_snds_kzrzp_svd","cup_svd_camo_d","cup_optic_pso_3"
// Spotter Rifle
...
class CUP_O_Ural_Reammo_CHDKZ {
	...
	TransportMagazines[] = {RIFLE_MAG,RIFLE_MAG,RIFLE_MAG,RIFLE_MAG,CARBINE_MAG,CARBINE_MAG,GLRIFLE_MAG,GLRIFLE_MAG,AR_MAG,AR_MAG,AR_MAG,AR_MAG,MMG_MAG,MMG_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,GLRIFLE_MAG_SMOKE,MAT_MAG,BASE_GRENADES,BASE_GRENADES,BASE_GRENADES,BASE_GRENADES,AT_MAG,AT_MAG,AT_MAG};
...
class Car {
  TransportWeapons[] = {AT};
  TransportMagazines[] = {RIFLE_MAG,RIFLE_MAG,CARBINE_MAG,GLRIFLE_MAG,AR_MAG,AR_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,GLRIFLE_MAG_SMOKE,AT_MAG,AT_MAG,AT_MAG};
...
class sf_rifleman_02 {// Base SF
  ...
  magazines[] = {"CUP_10Rnd_762x54_SVD_M:10",BASE_GRENADES};
...
class vicc: Fic_Soldier_Carbine {// Crew
  ...
  backpack[] = {"B_Battle_Belt_XL_F"};
  vest[] = {"CUP_V_CDF_CrewBelt_bwArmorMod"};
  headgear[] = {"SP_TSH04Helmet_Black"};
