...
#define GLRIFLE_MAG_SMOKE "CUP_1Rnd_SMOKE_GP25_M:6","CUP_1Rnd_SmokeRed_GP25_M:4","CUP_1Rnd_SmokeGreen_GP25_M:4",GLRIFLE_MAG_FLARE
...
class CUP_O_Ural_Reammo_CHDKZ {
	...
	TransportMagazines[] = {RIFLE_MAG,RIFLE_MAG,RIFLE_MAG,RIFLE_MAG,CARBINE_MAG,CARBINE_MAG,GLRIFLE_MAG,GLRIFLE_MAG,AR_MAG,AR_MAG,AR_MAG,AR_MAG,MMG_MAG,MMG_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,GLRIFLE_MAG_SMOKE,MAT_MAG,BASE_GRENADES,BASE_GRENADES,BASE_GRENADES,BASE_GRENADES,AT_MAG,AT_MAG,AT_MAG,AT_MAG,AT_MAG,AT_MAG,AT_MAG};
...
class Car {
  TransportWeapons[] = {AT};
  TransportMagazines[] = {RIFLE_MAG,RIFLE_MAG,CARBINE_MAG,GLRIFLE_MAG,AR_MAG,AR_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,GLRIFLE_MAG_SMOKE,AT_MAG,AT_MAG,AT_MAG,AT_MAG};
